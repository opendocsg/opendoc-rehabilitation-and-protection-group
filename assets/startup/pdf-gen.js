...
const BASEURL = 'opendoc-rehabilitation-and-protection-group'.replace('/', '')
...
const S3_PDF_FOLDER = 'opendocsg/opendoc-rehabilitation-and-protection-group'.replace(/\//g, '-') + (IS_PROD ? '' : '-staging')
